...
public class Launcher {
	 ...
	 */
	public static GhidraLaunchable main(String[] args) throws Exception {
		var layout = new GhidraApplicationLayout(new File("D:\\ghidra_9.2_PUBLIC_20201113\\ghidra_9.2_PUBLIC"));
